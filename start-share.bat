...
if "%ACCESS_TOKEN%"=="" (
  echo [WARN] ACCESS_TOKEN not set. Recommended for share mode.
  echo [WARN] Example: set ACCESS_TOKEN=your-token
)

echo [INFO] Starting share mode: http://127.0.0.1:%PORT%
